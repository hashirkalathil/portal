...
import { Loader2, Lock, User, ArrowRight, BookOpen, ChevronLeftIcon } from "lucide-react";
...
export default function FacultyLoginPage() {
    ...
    return (
        <div className="flex h-full w-full items-center justify-center bg-[#F5F6F8]">
            <div className="flex w-full max-w-6xl overflow-hidden bg-white shadow-2xl lg:grid lg:grid-cols-2 rounded-3xl">
                {/* Left Side: Form */}
                <div className="flex flex-col justify-center p-8 lg:p-24 relative z-10 bg-white order-2 lg:order-1">
                    ...
                    <div className="mb-10 text-center lg:text-left">
                        ...
                        <h1 className="text-3xl font-bold tracking-tight text-foreground">Faculty Portal</h1>
                        <p className="mt-2 text-muted-foreground text-lg">
                            Enter your staff ID to access your account.
                        </p>
                    </div>

                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div className="space-y-2.5">
                            <label className="text-sm font-semibold leading-none text-foreground">Staff ID or Email</label>
                ...
                <div className="hidden order-1 lg:order-2 bg-primary lg:flex lg:flex-col lg:justify-between lg:p-24 text-primary-foreground relative overflow-hidden">
                    <div className="relative z-10 h-full flex flex-col justify-center">
                        ...
                        <p className="mt-6 text-primary-foreground/80 text-xl leading-relaxed max-w-md">
                            Manage your courses, take attendance, and guide your students to success all in one place.
                        </p>
                    </div>
